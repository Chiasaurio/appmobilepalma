  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<AgroquimicosCubit>(create: (context) => AgroquimicosCubit()),
        ...
        BlocProvider<ErradicacionCubit>(create: (context) => ErradicacionCubit()),
        BlocProvider<FertilizacionCubit>(create: (context) => FertilizacionCubit()),
        BlocProvider<ViajeCubit>(create: (context) => ViajeCubit()),
        BlocProvider<ViajesPendientesCubit>(create: (context) => ViajesPendientesCubit()),
        BlocProvider<PesoExtractoraCubit>(create: (context) => PesoExtractoraCubit()),
        BlocProvider<SyncToServerCubit>(create: (context) => SyncToServerCubit()),
        BlocProvider<CensoProductivoCubit>(create: (context) => CensoProductivoCubit()),
      ],
