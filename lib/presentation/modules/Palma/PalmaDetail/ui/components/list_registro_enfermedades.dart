...
class RegistroEnfermedadesList extends StatefulWidget {
  ...
  @override
  State<RegistroEnfermedadesList> createState() => _RegistroEnfermedadesListState();
}
  ...
  Widget _renderSteps() {
    return ExpansionPanelList(
      expansionCallback: (int index, bool isExpanded) {
        setState(() {
          _registros[index] = _registros[index].changeExpanded(expanded: isExpanded);
        });
      },
      children: _registros.map<ExpansionPanel>((RegistroEnfermedadDatos val) {
        return ExpansionPanel(
          ...
          headerBuilder: (BuildContext context, bool isExpanded) {
            return ListTile(title: Text(val.enfermedad!.nombreEnfermedad));
          },
          body: Column(
            children: [
              Row(
                  ...
                  ? ListTile(
                      title: RichText(
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(
                              text: '${val.registrotratamiento!.descripcionProcedimiento}',
