  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: CustomScrollView(
        slivers: <Widget>[
          SliverAppBarGradient(title: 'Gestión de palmas', ruta: "palmas", showDrawer: true),
          SliverToBoxAdapter(
            child: DecoratedBox(
              decoration: BoxDecoration(color: kAppPrimaryColor),
              child: Row(
                children: [
          ...
          SliverList.list(children: [!_leftTab ? BuscarPalmaBody(nombreLote: nombreLote) : const PalmasLoteList()]),
        ],
      ),
    );
    /*   return Scaffold(
          ...
          child: Row(
            children: [
              GestureDetector(
                ...
                child: FaIcon(FontAwesomeIcons.arrowLeft, size: 25, color: Colors.white.withOpacity(0.7)),
              ),
