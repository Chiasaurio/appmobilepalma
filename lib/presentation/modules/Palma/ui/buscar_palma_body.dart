...
import 'package:apppalma/presentation/modules/Palma/ui/components/palma_sin_registros_info.dart';
    ...
    return BlocBuilder<PalmaCubit, PalmaState>(
      builder: (context, state) {
        if (state.palmaSeleccionada != null) {
          ...
          if (state.status == FormStatus.submissionSuccess || state is ErradicacionSinCausa) {
