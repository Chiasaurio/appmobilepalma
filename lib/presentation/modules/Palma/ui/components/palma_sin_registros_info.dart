...
class PalmaSinRegistrosInfo extends StatefulWidget {
  const PalmaSinRegistrosInfo({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'No se ha registrado nada sobre esta palma actualmente',
        ...
        child: Column(
          ...
          children: <Widget>[
            Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Linea palma: ', style: TextStyle(fontSize: 16.0, color: Colors.grey)),
                Flexible(
                  child: Text(
            ...
            Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Numero palma: ', style: TextStyle(fontSize: 16.0, color: Colors.grey)),
                Flexible(
                  child: Text(
