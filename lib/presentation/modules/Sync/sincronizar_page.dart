...
class SincronizacionPage extends StatefulWidget {
  ...
  const SincronizacionPage({super.key, this.disableBack, required this.routeName});
        ...
        child: Column(
          children: <Widget>[
            HeaderGradient(
              ...
              ruta: "/bajar-de-la-nube",
              disableBack: widget.disableBack != null ? widget.disableBack! : false,
              showDrawer: true,
            ),
            ...
            Padding(
              ...
              child: ElevatedButton(
                child: const Text("Bajar de la nube"),
                onPressed: () {
                  BlocProvider.of<SynToDeviceCubit>(context).bajarRegistrosDelServidor();
                },
              ),
            ),
          ],
