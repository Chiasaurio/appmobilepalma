...
class CensosEnfermedadesList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverList(
      delegate: SliverChildBuilderDelegate(childCount: palmasEnfermas.length, (context, index) {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Text('Fecha registro:', style: TextStyle(fontSize: 14.0, color: Colors.grey)),
                ...
                Row(
                  children: [
                    Row(
                      children: [
                        const Text('Linea:', style: TextStyle(fontSize: 14.0, color: Colors.grey)),
                        const SizedBox(width: 5),
                        Text(
                    ...
                    Row(
                      children: [
                        const Text('Numero:', style: TextStyle(fontSize: 14.0, color: Colors.grey)),
                        const SizedBox(width: 5),
                        Text(
                ...
                Row(
                  children: [
                    const Text('Enfermedad:', style: TextStyle(fontSize: 14.0, color: Colors.grey)),
                    const SizedBox(width: 5),
                    Text(
                ...
                if (palma.etapa != null)
                  Row(
                    children: [
                      const Text('Etapa:', style: TextStyle(fontSize: 14.0, color: Colors.grey)),
                      const SizedBox(width: 5),
                      Text(
                ...
                Row(
                  children: [
                    const Text('Estado palma:', style: TextStyle(fontSize: 14.0, color: Colors.grey)),
                    const SizedBox(width: 5),
                    Text(
                ...
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Observaciones:', style: TextStyle(fontSize: 14.0, color: Colors.grey)),
                    const SizedBox(width: 5),
                    Flexible(
                      child: Text(
                        '${palma.registroEnfermedad.observaciones}',
                        style: const TextStyle(color: Colors.black, fontSize: 14),
                        textAlign: TextAlign.start,
                      ),
                    ),
                ...
                if (palma.palma.estadopalma == EstadosPalma.pendientePorErradicar)
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          BlocProvider.of<ErradicacionCubit>(context).initErradicacion(palma);
                          Navigator.push(context, MaterialPageRoute(builder: (context) => const ErradicacionPage()));
                        },
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Text('Linea: ', style: TextStyle(fontWeight: FontWeight.bold)),
                    Text(palma.palma.numerolinea.toString()),
                  ],
                ),
                Row(
                  children: [
                    const Text('Numero: ', style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                Row(
                  children: [
                    const Text('Enfermedad: ', style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        final res = await BlocProvider.of<EnfermedadCubit>(
                          context,
                        ).darDeAltaEnfermedad(palma: palma.palma, registroEnfermedad: palma.registroEnfermedad);
                        if (context.mounted) {
                          Navigator.of(context).pop();
                          if (res) {
                            BlocProvider.of<TratamientoCubit>(context).obtenerPalmasEnfermas(palma.palma.nombreLote);
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                backgroundColor: kSuccessColor,
                                content: Text('Se dió de alta el registro correctamente.'),
                              ),
                            );
                          } else {
                            ScaffoldMessenger.of(context).showSnackBar(
