...
import 'package:apppalma/presentation/modules/Viajes/ui/peso_extractora/components/registrar_peso_dialog.dart';
...
class RegistrarPesoExtractoraButton extends StatefulWidget {
  const RegistrarPesoExtractoraButton({super.key});
