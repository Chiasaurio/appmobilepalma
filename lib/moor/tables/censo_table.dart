...
class Censo extends Table {
  ...
  BoolColumn get presenciaLote => boolean().withDefault(Constant(false))();
  BoolColumn get presenciaSector => boolean().withDefault(Constant(true))();
  ...
  TextColumn get estadoPlaga => text().withDefault(Constant('pendiente'))();
}
