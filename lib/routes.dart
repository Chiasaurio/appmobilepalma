  ...
  static Route<dynamic> generateRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      case '/pluviometro':
        return MaterialPageRoute(
          builder: (_) => PluviometroPage(
            ...
            disableBack: settings.arguments != null ? settings.arguments as bool : null,
          ),
        );
      case '/viajes':
        return MaterialPageRoute(
      ...
      case '/viajes/nuevoviaje':
        return MaterialPageRoute(builder: (_) => NuevoViajePage(routeName: settings.name!));
      case '/viajes/datosviaje':
        return MaterialPageRoute(builder: (_) => DatosViajesPage(routeName: settings.name!));
      case '/lotes':
        return MaterialPageRoute(
          builder: (_) => EscogerLotePage(disableBack: settings.arguments != null ? settings.arguments as bool : null),
        );
      case '/actualizar':
        return MaterialPageRoute(
      ...
      case '/lote/censo/enfermedades':
        return MaterialPageRoute(builder: (_) => CensoPage(routeName: settings.name!));
      case '/lote/censo/enfermedad':
        return MaterialPageRoute(builder: (_) => EnfermedadPage(routeName: settings.name!));
      case '/lote/palmas':
      ...
      case '/lote/cosechas':
        return MaterialPageRoute(builder: (_) => CosechaPage(routeName: settings.name!));
      case '/lote/cosechas/registrocosechas':
        return MaterialPageRoute(builder: (_) => RegistroCosechasDiarias(routeName: settings.name!));
      case '/lote/plateos':
        return MaterialPageRoute(builder: (_) => PlateoPage(routeName: settings.name!));
      case '/lote/plateos/registroplateos':
        return MaterialPageRoute(builder: (_) => RegistroPlateosDiarios(routeName: settings.name!));
      case '/lote/podas':
        return MaterialPageRoute(builder: (_) => PodaPage(routeName: settings.name!));
      case '/lote/podas/registropodas':
        return MaterialPageRoute(builder: (_) => RegistroPodasDiarias(routeName: settings.name!));
      case '/lote/censo/registrarplaga':
        return MaterialPageRoute(builder: (_) => PlagaPage(routeName: settings.name!));
      case '/lote/censo/plagas':
        return MaterialPageRoute(builder: (_) => AplicacionesPage(routeName: settings.name!));
      case '/lote/aplicaciones/palmasenfermas':
        return MaterialPageRoute(builder: (_) => PalmasEnfermasPage(routeName: settings.name!));
      case '/lote/aplicaciones/censospendientes':
        return MaterialPageRoute(builder: (_) => CensosPendientesPage(routeName: settings.name!));
      case '/lote/plagas/registrarfumigacion':
        return MaterialPageRoute(builder: (_) => RegistrarFumigacionPage(routeName: settings.name!));
      case '/lote/fertilizaciones':
        return MaterialPageRoute(builder: (_) => FertilizacionPage(routeName: settings.name!));
      case '/lote/fertilizaciones/registrofertilizaciones':
        return MaterialPageRoute(builder: (_) => RegistroFertilizacionesDiarias(routeName: settings.name!));
      case '/lote/censoproductivo':
        return MaterialPageRoute(builder: (_) => CensoProductivoPage(routeName: settings.name!));
      case '/lote/censoproductivo/nuevo':
        return MaterialPageRoute(builder: (_) => AgregarCensoProductivoPage(routeName: settings.name!));
